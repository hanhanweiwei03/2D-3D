<template>
  ...
  <div class="3d-viewer-container">
    ...
    <div class="viewer-header">
      ...
      <!-- 标题 -->
      <h1>Visual Language Model (Gemini 2.5 Flash)</h1>
    </div>
    <div id="result-area">
      <img id="result-image" src="/step4-direct-generate-by-gemini25-flash.png" alt="Result">
    </div>
    <!-- 可拖动的悬浮容器 -->
    <div
    ...
    >
      <!-- 可选：加拖动手柄（更直观） -->
      <div class="chat-drag-handle">☰ Move</div>
      <ChatBox />
    </div>
